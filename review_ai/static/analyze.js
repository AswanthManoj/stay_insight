...
let currentAnalysisType = "instant";

const searchInput = document.getElementById('searchInput');
const tokenSection = document.getElementById('tokenSection');
const analysisToken = document.getElementById('analysisToken');
const generateButton = document.getElementById('generateButton');
const analysisContent = document.getElementById('analysisContent');
const suggestionsList = document.getElementById('suggestionsList');
const fullAnalysisBtn = document.getElementById('fullAnalysisBtn');
const instantAnalysisBtn = document.getElementById('instantAnalysisBtn');
...
function setAnalysisType(type) {
    ...
    if (type === 'instant') {
        instantAnalysisBtn.classList.remove('bg-stone-600', 'hover:bg-stone-500', 'text-white');
        instantAnalysisBtn.classList.add('bg-[#7fd36e]', 'hover:bg-[#6ac259]', 'text-stone-800');
        fullAnalysisBtn.classList.remove('bg-[#7fd36e]', 'hover:bg-[#6ac259]', 'text-stone-800');
        fullAnalysisBtn.classList.add('bg-stone-600', 'hover:bg-stone-500', 'text-white');
    } else {
        fullAnalysisBtn.classList.remove('bg-stone-600', 'hover:bg-stone-500', 'text-white');
        fullAnalysisBtn.classList.add('bg-[#7fd36e]', 'hover:bg-[#6ac259]', 'text-stone-800');
        instantAnalysisBtn.classList.remove('bg-[#7fd36e]', 'hover:bg-[#6ac259]', 'text-stone-800');
        instantAnalysisBtn.classList.add('bg-stone-600', 'hover:bg-stone-500', 'text-white');
    }
}
...
fullAnalysisBtn.addEventListener('click', () => setAnalysisType('full'));
instantAnalysisBtn.addEventListener('click', () => setAnalysisType('instant'));
